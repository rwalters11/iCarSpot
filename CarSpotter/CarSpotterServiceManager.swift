//
//  CarSpotterServiceManager.swift
//  CarSpotter
//
...
class CarSpotterServiceManager : NSObject {
    
    
    // Service type must be a unique string, at most 15 characters long
    // and can contain only ASCII lowercase letters, numbers and hyphens.
    private let CarSpotterServiceType = "car-spotter"
...
extension CarSpotterServiceManager : MCNearbyServiceBrowserDelegate {
